...
9. **게임 실행 화면**:
#
<img src = "./image/ChoSung1.png" width="288" height = "170"><img src = "./image/ChoSung3.png" width="288" height = "170"><img src = "./image/ChoSung5.png" width="288" height = "170"><img src = "./image/ChoSung2.png" width="288" height = "170"><img src = "./image/ChoSung4.png" width="288" height = "170"><img src = "./image/ChoSung6.png" width="288" height = "170">
...
- **12.21.토 ~ 12.22.일**
>전반적인 코드를 수정하고, 문제 및 힌트 추가, 마지막 게임 클리어 페이지를 제작을 끝으로 막을 내린다! (짝짝짝~!!!) 코딩이 처음인 내가, 약 한 달간의 제작 기간을 걸쳐 GUI를 사용한 게임을 만들었다는 것은 놀라운 발전이라고 생각한다. 앞으로 더 배워가고 알아가야 할 것들이 많으니, 더 열심히 해야겠다. 시험 기간이 겹치지 않았다면 더 좋고 깔끔한 코드를 짤 수 있었지 않았을까..라는 아쉬움과 함께 내 자신 나름대로 좋은 프로젝트를 해낼 수 있어서 뿌듯하고 좋은 경험을 한 것 같다. 사진도 일일이 수정하고, 오류 찾아내고, 수정하고... 정말 힘들었다ㅋㅋ 2019년, 오늘 12월 22일 약 오후 3시에 글을 마무리하며, 최종 커밋합뉘당^^*