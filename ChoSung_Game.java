...
public class ChoSung_Game extends JFrame {
	...
	public ChoSung_Game() {
		...
		Game1_1Hint2.addActionListener(new ActionListener() { // 게임 1-2. 힌트 2 버튼 활성화
		...
		Game1_1Hint3.addActionListener(new ActionListener() { // 게임 1-3. 힌트 3 버튼 활성화
